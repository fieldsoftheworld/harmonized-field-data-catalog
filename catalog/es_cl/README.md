...
- **Fields in the latest edition (2025):** 9,109,125
- **Coordinate reference system:** EPSG:4258 (as published by the source; not reprojected)
- **Converted with:** fiboa-cli 0.21.0, vecorel-cli 0.2.16 ([converter](https://github.com/fiboa/cli/blob/main/fiboa_cli/datasets/es_cl.py))
...
|---|---:|---|---|---|
| 2025 | 9,109,125 | [2.5 GB](https://data.source.coop/ftw/harmonized-field-data/es_cl/year=2025/es_cl.parquet) | [1.0 GB](https://data.source.coop/ftw/harmonized-field-data/es_cl/year=2025/es_cl.pmtiles) | [es_cl-2025.json](https://data.source.coop/ftw/harmonized-field-data/es_cl/year=2025/es_cl-2025.json) |
