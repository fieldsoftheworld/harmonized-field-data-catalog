...
Belgium, Flanders field boundaries in the [fiboa](https://github.com/fiboa/specification) schema, 3 editions (2023, 2024, 2025). Every claim below is quoted from the source, the converter, or measured from the published files; each query was run before it was written down, and its output follows it as comments.
